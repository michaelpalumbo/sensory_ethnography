...
,
					"patching_rect" : [ 1500.0, 629.0, 78.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1542.0, 271.0, 251.0, 49.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1693.0, 443.0, 51.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 52.0, 267.0, 51.0, 22.0 ],
					"style" : "",
					"text" : "\"git diff\""
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1557.0, 392.0, 121.0, 76.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1500.0, 339.0, 428.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1365.0, 371.5, 96.0, 60.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1365.0, 443.0, 115.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1595.5, 576.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "print msg"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1500.0, 576.0, 83.0, 22.0 ],
					"style" : "",
					"text" : "print received"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1500.0, 543.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "ws @port 8080"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 52.0, 168.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1107.0, 129.0, 50.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1058.0, 90.0, 50.0, 102.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 918.0, 17.0, 150.0, 47.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 52.0, 14.0, 150.0, 47.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 800.0, 232.0, 150.0, 74.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 52.0, 301.0, 773.0, 20.0 ],
					"style" : "",
					"text" : "Response from node vr-git.js Note: need to figure out how to properly stringify prior to sending over websotet"
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 855.0, 290.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 52.0, 197.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "Some tested requests"
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 338.0, 85.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 52.0, 114.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "Select 2 commits"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 980.0, 651.0, 123.0, 22.0 ],
					"style" : "",
					"text" : "prepend new request"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 980.0, 682.0, 93.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 52.0, 164.0, 93.0, 22.0 ],
					"style" : "",
					"text" : "print @popup 1"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 980.0, 571.0, 48.0, 22.0 ],
					"style" : "",
					"text" : "cycle 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 980.0, 611.0, 160.0, 22.0 ],
					"style" : "",
					"text" : "sprintf symout git diff %s %s"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1019.0, 134.0, 154.0, 47.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 853.0, 13.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 975.0, 497.0, 80.0, 22.0 ],
					"style" : "",
					"text" : "route commit"
				}
...
,
					"patching_rect" : [ 975.0, 450.0, 169.0, 35.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 975.0, 529.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 975.0, 423.0, 71.0, 21.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 975.0, 392.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "* 4"
				}
...
,
					"patching_rect" : [ 975.0, 289.0, 169.0, 35.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 975.0, 330.0, 98.0, 22.0 ],
					"style" : "",
					"text" : "prepend append"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 975.0, 362.0, 100.0, 22.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 719.333374, 360.0, 144.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 771.333313, 389.0, 57.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 719.333374, 389.0, 50.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 705.0, 174.0, 73.0, 22.0 ],
					"style" : "",
					"text" : "t s clear 4 b"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1029.0, 32.0, 150.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 705.0, 302.0, 82.0, 22.0 ],
					"style" : "",
					"text" : "prepend read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 705.0, 134.0, 302.0, 22.0 ],
					"style" : "",
					"text" : "\"Macintosh HD:/Users/mp/thst6329/docs/logs/log.xml\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 988.0, 84.0, 169.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 938.0, 32.0, 89.0, 22.0 ],
					"style" : "",
					"text" : "loadmess path"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 938.0, 58.0, 69.0, 22.0 ],
					"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
					"style" : "",
					"text" : "thispatcher"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 772.0, 256.0, 71.0, 21.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 772.0, 222.0, 32.0, 21.0 ],
					"style" : "",
					"text" : "idx"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 705.0, 332.0, 53.0, 21.0 ],
					"style" : "",
					"text" : "toxine"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 52.0, 13.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 52.0, 49.0, 142.0, 22.0 ],
					"style" : "",
					"text" : "filewatch new_page.html"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 714.5, 355.0, 694.0, 355.0, 694.0, 216.0, 780.0, 216.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 781.5, 283.0, 798.0, 283.0, 798.0, 283.0, 984.5, 283.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 997.5, 121.0, 1017.0, 121.0, 1017.0, 165.0, 759.0, 165.0, 759.0, 165.0, 714.5, 165.0 ],
					"order" : 1,
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-92", 0 ],
					"midpoints" : [ 1509.5, 661.0, 1462.5, 661.0, 1462.5, 532.0, 1509.5, 532.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 853.833374, 385.0, 870.0, 385.0, 870.0, 247.0, 781.5, 247.0 ],
					"source" : [ "obj-61", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 732.5, 209.0, 780.0, 209.0 ],
					"order" : 2,
					"source" : [ "obj-9", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 732.5, 250.0, 781.5, 250.0 ],
					"order" : 1,
					"source" : [ "obj-9", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-62", 0 ],
					"midpoints" : [ 732.5, 209.0, 960.0, 209.0, 960.0, 355.0, 984.5, 355.0 ],
					"order" : 0,
					"source" : [ "obj-9", 1 ]
				}
